...
DECLSPEC_IMPORT WINBOOL WINAPI WTSAPI32$WTSQueryUserToken(ULONG, PHANDLE);
DECLSPEC_IMPORT PCHAR WINAPI WTSAPI32$WTSSessionStateToString(WTS_CONNECTSTATE_CLASS);
...
WINADVAPI HANDLE WINAPI ADVAPI32$ImpersonateSelf();
WINADVAPI HANDLE WINAPI ADVAPI32$GetCurrentThreadToken();
